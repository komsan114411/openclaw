...
export const CORE_RULES =
  ...
  '9. ถ้าข้อมูลในคลังความรู้ขัดแย้งกับข้อมูลในประวัติแชท ให้ใช้ข้อมูลจากคลังความรู้เท่านั้นเพราะเป็นข้อมูลล่าสุด';
...
export function buildKnowledgeSection(knowledgeBase: KnowledgeEntry[]): string {
  ...
  return `คลังความรู้ (ข้อมูลล่าสุดของธุรกิจ — ข้อมูลนี้ถูกต้องที่สุดและเป็นปัจจุบัน ให้ใช้ข้อมูลนี้ตอบลูกค้าเท่านั้น ถ้าข้อมูลในประวัติแชทขัดแย้งกับข้อมูลนี้ ให้ใช้ข้อมูลจากคลังนี้เสมอ ห้ามแต่งเพิ่มเอง ถ้าลูกค้าถามเรื่องที่ไม่มีในนี้ให้แจ้งว่าไม่มีข้อมูลและแนะนำติดต่อแอดมิน):\n${entries}`;
}

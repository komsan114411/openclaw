          ...
          <div className="lg:col-span-4 xl:col-span-3 space-y-4">
            ...
            <div className="relative group">
              <input
                ...
                className="w-full h-14 pl-12 pr-6 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/5 shadow-2xl focus:bg-white/[0.05] focus:ring-0 font-black text-[10px] tracking-widest uppercase transition-all text-white placeholder:text-slate-600"
              />
